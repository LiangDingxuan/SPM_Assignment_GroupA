        ...
        for (const [adjX, adjY] of adjacentPositions) {
            if (this.isInBounds(adjX, adjY)) {
                ...
                if (adjBuilding.buildingType === 'Industry') {
                    return 1;
                } else if (adjBuilding.buildingType === 'Residential' || adjBuilding.buildingType === 'Commercial') {
                    score += 1;
        ...
        for (let i = 0; i < this.size; i++) {
            for (let j = 0; j < this.size; j++) {
                ...
                if (building !== ' ' && building.buildingType === 'Residential') {
                    ...
                    for (const [adjX, adjY] of adjacentPositions) {
                        if (this.isInBounds(adjX, adjY) && this.grid[adjX][adjY].buildingType === 'Industry') {
                            coins += 1;
                        }
                    }
                }
